...
import torch
from functions.deform_attn_func import (
...
def check_forward_equal_with_pytorch_double():
    ...
    print(
        f'* {fwdok} check_forward_equal_with_pytorch_double: max_abs_err {max_abs_err:.2e}'
...
def check_forward_equal_with_pytorch_float():
    ...
    print(
        f'* {fwdok} check_forward_equal_with_pytorch_float: max_abs_err {max_abs_err:.2e} '
        f'max_rel_err {max_rel_err:.2e}'
    )
